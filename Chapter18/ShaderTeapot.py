...
mat = Material("shaders/texturedvert.vs", "shaders/lambert.vs")
quat_teapot.add_component(LoadMesh(quat_teapot.vao_ref, mat, GL_TRIANGLES, "../models/granny.obj", "../images/granny.png"))
